...
const EmpleadosView = () => {
    ...
    const [viewGroupPhoto, setViewGroupPhoto] = useState(false);
    ...
    return (
        <section className="px-4 py-8 md:py-24 mx-auto max-w-7xl bg-white text-center">
            <button
                className="mb-6 px-6 py-2 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-700 transition"
                onClick={() => setViewGroupPhoto(!viewGroupPhoto)}
            >
                {viewGroupPhoto ? "Ver Empleados Individuales" : "Ver Foto Grupal"}
            </button>

            {viewGroupPhoto ? (
                <div className="relative w-full max-w-4xl mx-auto">
                    <motion.img
                        src="/public/empleados/imagen1.jpg"
                        alt="nuestro equipo"
